...
Config.Lock = true --lock the weather
...
Config.NewWeatherMs = math.random(120000,180000) --This is used only if Config.Lock = True (It's the duration of a cycle)

Config.InitialWeatherType = { --The Weather when the script start 
    {name = "CLEAR", hash = 0x36A83D84, use = false},
    {name = "EXTRASUNNY", hash = 0x97AA0A79, use = false},
    {name = "CLOUDS", hash = 0x30FDAF5C, use = false},
    {name = "OVERCAST", hash = 0xBB898D2D, use = false},
